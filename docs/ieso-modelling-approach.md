...
$$
\begin{aligned}
e &= \dot{m}_{T,in} \left(\bar{h}_{T,in} - \bar{h}_{C,in}\right) \\
  &\quad - \dot{m}_{X,in} \left(\bar{h}_{X,in} - \bar{h}_{C,in}\right)
\end{aligned} \tag{2}
$$
...
$$
\begin{aligned}
e_\text{strg}(i) &= e_\text{strg}(i-1) + \sqrt{r_\text{strg}} \times e_\text{char}(i) \\
&\quad - \frac{e_\text{disc}(i)}{\sqrt{r_\text{strg}}}
\end{aligned} \tag{13}
$$
...
$$
\begin{aligned}
e_\text{strg}(1) &= \frac{c_\text{strg}}{2} + \sqrt{r_\text{strg}} \times e_\text{char}(1) \\
&\quad - \frac{e_\text{disc}(1)}{\sqrt{r_\text{strg}}}
\end{aligned} \tag{14}
$$
